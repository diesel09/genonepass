...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/theonejpas/gen/GENERADOR-DE-GENERADORES/Install/trans &> /dev/null
...
wget https://raw.githubusercontent.com/diesel09/genonepass/GENERADOR-DE-GENERADORES/gerador/gerar.sh &>/dev/null
