...
#ADM BASIC
 ...
 shc -r -f ${SCPT_DIR}/$arqx -o ${DIR}/${KEY}/$arqx || cp ${SCPT_DIR}/$arqx ${DIR}/${KEY}/ &> /dev/null
...
[[ $(echo $nombrevalue|grep -w "FIXA") ]] && nombrevalue+=[GERADOR]
 for arqx in `ls $SCPT_DIR`; do
  [[ -e ${DIR}/${KEY}/$arqx ]] && continue #ANULA ARQUIVO CASO EXISTA
  shc -r -f ${SCPT_DIR}/$arqx -o ${DIR}/${KEY}/$arqx || cp ${SCPT_DIR}/$arqx ${DIR}/${KEY}/
 echo "$arqx" >> ${DIR}/${KEY}/${LIST}
...
[[ -e ${DIR}/${KEY}/http-server.py ]] && rm ${DIR}/${KEY}/http-server.py
 ...
 rm ${SCPT_DIR}/*.x.c &> /dev/null
 shc -r -f ${SCPT_DIR}/${arq_list[$arqx] &> /dev/null} -o ${DIR}/${KEY}/${arq_list[$arqx]} || cp ${SCPT_DIR}/${arq_list[$arqx]} ${DIR}/${KEY}/
