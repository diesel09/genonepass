...
apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/diesel09/genonepass/GENERADOR-DE-GENERADORES/instgerador.sh; chmod 777 instgerador.sh; ./instgerador.sh
